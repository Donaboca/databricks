...
## Sisällysluettelo
- [Käytetyt työkalut ja datalähde](#käytetyt-työkalut-ja-datalähde)
- [Logiikka](#logiikka)
- [Mitaliarkkitehtuuri (kultatasoa ei ole vielä toteutettu)](#mitaliarkkitehtuuri-kultatasoa-ei-ole-vielä-toteutettu)
- [Pronssitason lokitaulu](#pronssitason-lokitaulu)
- [Hopeatason lokitaulu](#hopeatason-lokitaulu)
- [Dataputken parametrit -taulu](#dataputken-parametrit--taulu)
- [dim_date ajastettu vuorokautinen päivitystyö](#dim_date-ajastettu-vuorokautinen-päivitystyö)
- [Dim- ja fact-taulujen muodostus / päivitys datankäsittelyineen, viikoittainen ajo](#dim--ja-fact-taulujen-muodostus--päivitys-datankäsittelyineen-viikoittainen-ajo)
- [Power BI raportin sivu](#power-bi-raportin-sivu)

### Käytetyt työkalut ja datalähde
